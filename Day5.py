...
SCREEN_HEIGHT = 600
SQUARE_SIZE = 50
SQUARE_COLOR_1 = (0, 128, 255)
SQUARE_COLOR_2 = (0, 200, 255)
ANIMATION_OFFSET = 3
BLOCK_COLOR = (255, 0, 0)
BLOCK_SIZE = 70
...
while True:
    ...
    if moving:
        ...
        if frame_counter >= frame_delay:
            ...
            frame_counter = 0
            animation_offset = ANIMATION_OFFSET if current_frame == 1 else -ANIMATION_OFFSET
    else:
        current_frame = 0
        animation_offset = 0
    
    # Determine player color based on animation frame
    player_color = SQUARE_COLOR_1 if current_frame == 0 else SQUARE_COLOR_2

    # Player collision with blocks
    player_rect = pygame.Rect(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + animation_offset, SQUARE_SIZE, SQUARE_SIZE)
    for block in blocks:
    ...
    # Draw player with animation frame and offset
    pygame.draw.rect(screen, player_color, (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + animation_offset, SQUARE_SIZE, SQUARE_SIZE))
